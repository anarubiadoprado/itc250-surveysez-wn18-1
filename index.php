<?php
/**
*index.php is the first page of our SurveySez application. It's s based on demo_list_pager.php along with demo_view_pager.php provides a sample web application
 *
 ...
 * 
 * @package SurveySez
 * @author Ana Rubia do Prado <\anarubiadoprado92@gmail.com>
 * @version 0.1 2018/02/06
...
{#records exist - process
    ...
    echo "<div align=center>The are currently no surveys.</div>";	
}
	
	#TO DO: link to add surveys.
